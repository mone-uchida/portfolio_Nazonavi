  ...
  describe "scope" do
    ...
    describe "open" do
      it "終了日が本日以降のイベントが含まれる" do
        event3 = create(:event, id: 3, finish_at: Date.new(2030, 01, 01))
      ...
      it "終了日が本日より前のイベントが含まれない" do
        event5 = create(:event, id: 5, finish_at: Date.new(2020, 01, 01))
    ...
    describe "popular_events" do
      ...
      it "いいねが多い順に取得できる" do
        ...
        favorite = create(:favorite, event_id: 10)
        favorite2 = create(:favorite, event_id: 10)
        favorite3 = create(:favorite, event_id: 11)
